...
export const usernameSchema = z.string({ error: 'validation.FIELD_REQUIRED' })
...
export const emailSchema = z.string({ error: 'validation.FIELD_REQUIRED' })
    .email({ error: 'validation.INVALID_EMAIL' });

export const passwordSchema = z.string({ error: 'validation.FIELD_REQUIRED' })
